...
router.get('/:id/cancellation-preview', restrictTo('customer'), verifyCustomerBookingAccess, bookingController.getCancellationPreview);
...
router.post('/:id/cancel', restrictTo('customer'), strictLimiter, verifyCustomerBookingAccess, bookingController.cancelBooking);
